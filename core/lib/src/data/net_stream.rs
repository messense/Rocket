...
pub fn try_socket_stream_downcast(stream: &mut dyn NetworkStream) -> Option<NetStream> {
...
#[inline]
#[cfg(not(unix))]
pub fn try_socket_stream_downcast(_stream: &mut dyn NetworkStream) -> Option<NetStream> {
    None
}
